...
const Addform = () => {
  ...
  const handleSubmit = (e) => {
    ...
    thePost ? dispatch({type: "EditPost", id: thePost.id, payload:data, posts: state.posts}) : dispatch({type: "AddPost", payload: {id: data.id,post :data, num:0, comment:[]},posts: state.posts});
